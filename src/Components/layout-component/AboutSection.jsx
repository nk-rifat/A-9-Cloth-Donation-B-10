    ...
    return (
        <section className=" py-16 px-6 bg-gray-50">
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-4xl font-bold text-green-600 mb-6">About WinterHope</h2>
                ...
                <h3 className="text-3xl font-bold text-green-600 mb-4">How You Can Contribute</h3>
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h4 className="text-2xl font-semibold text-blue-700 mb-2"> Donate Clothes</h4>
                        <p className="text-gray-600 ">Contribute coats, scarves, gloves, and other winter clothing at our collection points.</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h4 className="text-2xl font-semibold text-blue-700 mb-2"> Monetary Donations</h4>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h4 className="text-2xl font-semibold text-blue-700 mb-2"> Volunteer</h4>
                ...
                <p className="text-xl text-black mt-8">
                    Every small effort counts! Together, we can make a difference and bring hope this winter.
                </p>
            </div>
        </section>
