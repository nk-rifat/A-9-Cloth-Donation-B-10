...
const HowToHelp = () => {
    return (
        <div>
            ...
            <section className=" bg-white py-16 px-6 mt-9">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-green-600 mb-6">How To Help</h2>
                    ...
                    {/* Collection Points */}
                    <div className="mt-12">
                        <h3 className="text-3xl font-bold text-green-600 mb-4">Collection Points</h3>
                    ...
                    {/* Supported Divisions */}
                    <div className="mt-12">
                        <h3 className="text-3xl font-bold text-green-600 mb-4">Supported Divisions</h3>
